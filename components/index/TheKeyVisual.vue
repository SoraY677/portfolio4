...
<script>
import name from "@/components/index/TheKeyVisualName";
import anime from "@/components/index/TheKeyVisualAnime";
import LinkList from "@/components/index/TheKeyVisualLink";
export default {
  components: {
    name,
    anime,
